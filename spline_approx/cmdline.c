...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "  -m, --my-opt=INT        Another integer option,      this time the \n                            description of the option should be \"quite\" long \n                            to      require wrapping... possibly more than one \n                            wrapping :-)      especially if I\n                            require a line break",
