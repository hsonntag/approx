...
const char *gengetopt_args_info_help[] = {
  ...
  "  -i, --int-opt=INT            Anzahl der Messwerte in den Kanälen",
  "  -f, --frq-opt=INT            Binäre Kodierung der Indize darzustellender \n                                 Amplitudenspektren",
  "  -t, --time-opt=INT           Binäre Kodierung der Indize darzustellender \n                                 Parameter",
  "  -r, --samplingrate-opt=INT   Ganzzahlige Abtastrate in Hz",
  "  -s, --channel_start-opt=INT  Startposition der Kanäle in den Messwerten",
  "  -c, --channel_count-opt=INT  Anzahl der Kanäle",
  "  -q, --qrs_start-opt=INT      Startposition eines QRS-Komplexes",
  "  -l, --qrs_length-opt=INT     Länge des QRS-Komplexes",
  "      --enum-opt=STRING        Eine Zeichenkettenoption mit einer Liste von \n                                 Werten  (possible values=\"xcorr\", \"rms\" \n                                 default=`rms')",
    0
};
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'i':	/* Anzahl der Messwerte in den Kanälen.  */
          ...
          break;
        case 'f':	/* Binäre Kodierung der Indize darzustellender Amplitudenspektren.  */
          ...
          break;
        case 't':	/* Binäre Kodierung der Indize darzustellender Parameter.  */
          ...
          break;
        case 'r':	/* Ganzzahlige Abtastrate in Hz.  */
          ...
          break;
        case 's':	/* Startposition der Kanäle in den Messwerten.  */
        ...
        case 'c':	/* Anzahl der Kanäle.  */
          ...
          break;
        case 'q':	/* Startposition eines QRS-Komplexes.  */
          ...
          break;
        case 'l':	/* Länge des QRS-Komplexes.  */
        ...
        case 0:	/* Long option with no short option */
          /* Eine Zeichenkettenoption mit einer Liste von Werten.  */
